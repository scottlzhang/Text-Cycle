...
<div id = "addBook">
<div id="topnav" class="topnav"> What books do you need? <a href="" class="add"><span>Add</span></a> </div>
  <fieldset id="add_menu">
      <p>
      <label for="username">Book Name</label>
      <input id="bookname" name="bookname" value="" title="bookname" tabindex="4" type="text">
      </p>
      <p>
        <label for="password">Author</label>
        <input id="author" name="author" value="" title="author" tabindex="5" type="text">
      </p>
      <p>
      ...
      <p>
        <label>Swap<input type="checkbox"  value="swap" /></label>
        <label>Rent<input type="checkbox"  value="rent" /></label>  
        <label>Buy<input type="checkbox"   value="buy" /></label>
      </p>
      <p align="center">
        <input id="add" value="Add" tabindex="6" type="submit">
      </p>
    </form>
  </fieldset>
</div>
...
<div id = "haveBook">
<div id="topnav" class="topnav"> What books do you have? <a href="" class="addHave"><span>Add</span></a> </div>
	<fieldset id="add_menu2">
      <p>
      <label for="username">Book Name</label>
      <input id="bookname2" name="bookname2" value="" title="bookname2" tabindex="4" type="text">
      </p>
      <p>
        <label for="password">Author</label>
        <input id="author2" name="author2" value="" title="author2" tabindex="5" type="text">
      </p>
      <p>
        <label for="password">ISBN</label>
      ...
      <p>
        <label>Swap<input type="checkbox" id="swap" value="swap" /></label>
        <label>Rent<input type="checkbox" id="rent" value="rent" /></label>  
        <label>Buy<input type="checkbox"  id="buy" value="buy" /></label>
      </p>
      <p align="center">
        <input id="add2" value="Add" tabindex="6" type="submit">
      </p>
    </form>
  </fieldset>
</div>
...
<div class = "scroll-pane">
	...
	//Traverses $result_need_books to display each book title	
		if($result_need_books){
			foreach ($result_need_books as $row) {
                           echo "<tr><td><a href = '#' data-reveal-id='". $row["isbn"] ."' class='popup-link'>".
						   $row["title"]."</a></td></tr>";	}
		}
	?>
    </tbody>
