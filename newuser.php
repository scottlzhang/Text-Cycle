<?php
 ...
 if(file_exists("../upload/". $_FILES["file"]["name"])){
  ...
  /*Check if user profile already exists!!!!!(yet to do)*/

$sql_insert = "INSERT INTO `profile` (fname, lname, email,picture,password)
VALUES
('".mysql_real_escape_string($fname)."','".mysql_real_escape_string($lname)."
	','".mysql_real_escape_string($email)."','".mysql_real_escape_string($picture).
...
$sql_outbox = "CREATE TABLE outbox_".$id." (`to` int, `msg_ids` varchar(500), `isbn` varchar(30))";
